...
public class Drivetrain {
  ...
  private final SwerveModule m_frontRight = new SwerveModule(8,7,10);
  private final SwerveModule m_backLeft = new SwerveModule(3,4,11);
  private final SwerveModule m_backRight = new SwerveModule(6,5,12);
  ...
  public void drive(double xSpeed, double ySpeed, double rot, boolean fieldRelative) {
    ...
    System.out.println(m_backRight.getState().angle.getDegrees());
  }
